        ...
        <v-card-text>
          <v-list>
            ...
            >
              ...
              <v-list-item-title>{{ formatElementType(type) }}</v-list-item-title>
            </v-list-item>
          </v-list>
        </v-card-text>
      </v-card>
...
const TableElement = defineAsyncComponent(() => import('./TableElement.vue'))
const SignatureElement = defineAsyncComponent(() => import('./SignatureElement.vue'))
